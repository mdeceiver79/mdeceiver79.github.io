...
const itemCoolant = Registry.addItem("Coolant Circuit", "Consume to ignore a wound for [[rule:Gets Hot:Overheating]] plasma weapons like the [[weapon:Plasma Gun]] and [[weapon:Plasma Pistol]].", true);
...
const ruleGetsHot = Registry.addRule("Gets Hot", "Death if 3 or more 1's are rolled at once.", "If 3 or more 1's are rolled at once the bearer of this weapon dies. ");
...
const weaponPlasmaGun = Registry.addWeapon("Plasma Gun", "", "Special", 1, "3D6", 1, null, [ruleGetsHot, ruleOverload]);
...
const weaponAssaultCannon = Registry.addWeapon("Assault Cannon", "", "Special", 1, "3D6", 0, null, [ruleSustainedFire, ruleGetsHot]);
...
const weaponPlasmaPistol = Registry.addWeapon("Plasma Pistol", "", "Pistol", 1, "3D6", 1, 6, [ruleOverwatch, ruleGetsHot]);
