...
const weaponLasRifle = WeaponRegistry.add("Las Rifle", "Basic", 2, "1D6", 0, null, []);
...
const weaponLasPistol = WeaponRegistry.add("Las Pistol", "Pistol", 2, "1D6", 0, 6, [ruleOffhand]);
...
const npcHenchman = NpcRegistry.add("Henchman", "Grunt", "Generic", 4, "1D6-2", [weaponLasRifle], []);
const npcHenchmanMelee = NpcRegistry.add("Henchman (melee)", "Grunt", "Generic", 4, "1D6-1", [weaponLasPistol], []);
const npcRobot = NpcRegistry.add("Robot", "Character", "Generic", 4, "2D6", [weaponAssaultCannon], [ruleBulky]);
const npcStormTrooper = NpcRegistry.add("Storm Trooper", "Grunt", "Generic", 4, "1D6-1", [weaponSpecialIssueLasgun, weaponGrenade], []);
const npcStormTrooperSarg = NpcRegistry.add("Storm Trooper Sergeant", "Grunt", "Generic", 4, "1D6", [weaponBolter, weaponPlasmaPistol, weaponGrenade], []);
const npcAssassin = NpcRegistry.add("Assassin", "Specialist", "Generic", 4, "1D6-1", [weaponSniperRifle, weaponLasPistol], []);
const npcPurestrain = NpcRegistry.add("Purestrain", "Grunt", "Genestealer", 6, "3D6", [], [ruleBulky]);
const npcAcolyte = NpcRegistry.add("Acolyte", "Grunt", "Genestealer", 4, "2D6-1", [weaponLasPistol], [ruleBulky]);
const npcNeophyte = NpcRegistry.add("Neophyte", "Grunt", "Genestealer", 4, "1D6-2", [weaponLasRifle], []);
const npcNeophyteMelee = NpcRegistry.add("Neophyte (melee)", "Grunt", "Genestealer", 4, "1D6-1", [weaponLasPistol], []);
...
const npcChaosCultist = NpcRegistry.add("Cultist", "Grunt", "Chaos", 4, "1D6-2", [weaponLasRifle], []);
const npcChaosCultistMelee = NpcRegistry.add("Cultist (melee)", "Grunt", "Chaos", 4, "1D6-1", [weaponLasPistol], []);
const npcChaosCultistFlamer = NpcRegistry.add("Cultist (flamer)", "Specialist", "Chaos", 4, "1D6-3", [weaponLasPistol, weaponFlamer], []);
